...
try:
    ...
    Grade_dropdown = WebDriverWait(driver, 10).until(
        EC.presence_of_element_located((By.XPATH, "//html/body/app-root/app-staffing/app-main-layout/div/div/div[2]/div/div/div[2]/div/div[5]/select"))
    )
    ...
    # Select Pu dropdown
    Pu_dropdown = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH," /html/body/app-root/app-staffing/app-main-layout/div/div/div[2]/div/div/div[2]/div/div[2]/select"))
    )
    Pu_dropdown.click()
    logging.info("Clicked on PU dropdown...")
    time.sleep(2)
    select_Pu = WebDriverWait(driver, 10).until(
         EC.element_to_be_clickable((By.XPATH, "/html/body/app-root/app-staffing/app-main-layout/div/div/div[2]/div/div/div[2]/div/div[2]/select/option[5]"))
    )
    select_Pu.click()
    logging.info("Selected PU from the dropdown...")
    time.sleep(2)
