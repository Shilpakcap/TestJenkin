...
try:
    ...
    # Select PU dropdown
    pu_dropdown = wait.until(EC.element_to_be_clickable((By.XPATH, "//select[contains(@id, 'pu')]")))
    pu_dropdown.click()
    time.sleep(2)
    select_pu = wait.until(EC.element_to_be_clickable((By.XPATH, "//select[contains(@id, 'pu')]/option[5]")))
    select_pu.click()
    ...
    # Scroll and select Industry
    industry_dropdown = wait.until(EC.element_to_be_clickable((By.XPATH, "//select[contains(@id, 'industry')]")))
    driver.execute_script("arguments[0].scrollIntoView()", industry_dropdown)
    time.sleep(2)
    industry_dropdown.click()
    auto_option = wait.until(EC.element_to_be_clickable((By.XPATH, "//select[contains(@id, 'industry')]/option[4]")))
    auto_option.click()
